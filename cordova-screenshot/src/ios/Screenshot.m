...
- (UIImage *)modefyImageWithImage:(UIImage *)image Width:(NSNumber *)width Height:(NSNumber *)height Mode:(NSString *)mode {
    ...
    if ([mode isEqualToString:@"fit"]) {//等比缩放
        ...
        NSInteger widthDiff = coverImage.size.width - width.floatValue;
        NSInteger heightDiff = coverImage.size.height - height.floatValue;
        ...
        if (widthDiff > heightDiff) {
            ...
            NSInteger targetWidth = width.floatValue * scale;
            ...
            NSInteger targetHeight = height.floatValue * scale;
...
- (UIImage *)resizeImageWithImage:(UIImage *)image Width:(NSNumber *)width Height:(NSNumber *)height {
    ...
    NSInteger imageWidth = image.size.width * scaleSize;
    NSInteger imageHeight = image.size.height * scaleSize;
